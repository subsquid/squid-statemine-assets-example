...
The peculiarity of this sample project is that it allows to showcase a slightly more complex project with multiple events and various states for the database entities defined.

> :memo: **Note:** Please take note that all of the events Interfaces have *getter* functions and data-exchange interfaces defined in `event_helpers.ts`.
